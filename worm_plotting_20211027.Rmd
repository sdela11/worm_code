...
#Possible new way to add the inv_lvl and forest_type columns. It takes the specified elements and creates a new column.
...
write.csv(wormplot.df, "wormplot.df.csv")
...
#Plots earthworm ecol groups stacked on top of each other.
```{r }
