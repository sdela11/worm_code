...
worm.R.df <- matrix(data = NA, nrow = 8, ncol = 1)
worm.R.df[,1] <- c("C2A","C2B","C5A","C5B", "D2A", "D2B","D5A", "D5B")
colnames(worm.R.df) <- c("site")

#worm.R.ecogroup.df

worm_site_summary <- merge(x = worm.R.df, y = worms.org.musEX, all.x = TRUE) # merge expected values df with collected data.
