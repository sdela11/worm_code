...
```
IMPORTANT: 2019 and 2021 worms come from different .csv files with different labelling. 2019 and 2021 data need to be plotted separately and then combined.
...
mean_site_biomass_A <- wormplot.FUN(wormplot.stat, "mean_site_biomass_2019", "2019")

print(mean_site_biomass_A)

#2021 (Plot B)
#wormplot.FUN(wormplot.stat, "mean_site_biomass_2021", "2021")
mean_site_biomass_B <- wormplot.FUN(wormplot.stat, "mean_site_biomass_2021", "2021")
