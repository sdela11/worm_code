...
worm.R.ecogroup.df <- matrix(data = NA, nrow = 40, ncol = 2)
worm.R.ecogroup.df[,1] <- c(rep("C2A", 5), rep("C2B", 5), rep("C5A", 5), rep("C5B", 5), 
                rep("D2A", 5), rep("D2B", 5), rep("D5A", 5), rep("D5B", 5))
worm.R.ecogroup.df[,2] <- c("endogeic", "epi-endogeic", "epi-anecic", "epigeic", "epi-endogeic.anecic")
